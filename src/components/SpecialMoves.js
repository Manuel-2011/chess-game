            ...
            <div className="special__box" onClick={(e) => e.stopPropagation()}>
                ...
                <section className="special-section">
                    ...
                    <div className="special-section__imgs-box">
                        <img className="special-section__img" src="./img/enPassant1.jpg" alt="En Passant first move"/>
                        <img className="special-section__img" src="./img/enPassant2.jpg" alt="En Passant second move"/>
                    </div>
                    <p className="special-section__text">
                ...
                <section className="special-section">
                    ...
                    <div className="special-section__imgs-box">
                        <img className="special-section__img" src="./img/promotePawn.jpg" alt="Promote pawn first move"/>
                        <img className="special-section__img" src="./img/promotePawn2.jpg" alt="Promote pawn second move"/>
                    </div>
                    <p className="special-section__text">
