...
import enPassant1 from '../img/enPassant1.JPG'
import enPassant2 from '../img/enPassant2.JPG'
import castling1 from '../img/castling1.JPG'
import castling2 from '../img/castling2.JPG'
import promotePawn1 from '../img/promotePawn.JPG'
import promotePawn2 from '../img/promotePawn2.JPG'
            ...
            <div className="special__box" onClick={(e) => e.stopPropagation()}>
                ...
                <section className="special-section">
                    ...
                    <div className="special-section__imgs-box">
                        <img className="special-section__img" src={enPassant1} alt="En Passant first move"/>
                        <img className="special-section__img" src={enPassant2} alt="En Passant second move"/>
                    </div>
                    <p className="special-section__text">
                ...
                <section className="special-section">
                    ...
                    <div className="special-section__imgs-box">
                        <img className="special-section__img" src={castling1} alt="Castling first move"/>
                        <img className="special-section__img" src={castling2} alt="Castling second move"/>
                    </div>
                    <p className="special-section__text">
                ...
                <section className="special-section">
                    ...
                    <div className="special-section__imgs-box">
                        <img className="special-section__img" src={promotePawn1} alt="Promote pawn first move"/>
                        <img className="special-section__img" src={promotePawn2} alt="Promote pawn second move"/>
                    </div>
                    <p className="special-section__text">
